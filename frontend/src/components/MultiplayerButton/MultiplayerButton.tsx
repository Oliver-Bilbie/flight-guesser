...
const MultiplayerButton: FC<MultiplayerButtonProps> = ({ onClick }) => {
  return (
    <button className="multiplayer-button" onClick={onClick}>
      <svg height="2rem" width="2rem" viewBox="0 0 24 24" fill="currentColor">
        <g>
